    ...
    <ion-content :fullscreen="true">
      ...
      <div id="container">
        ...
        <div class="card2">
          ...
          <ul>
            <li>Connect your device to your computer via USB cable.</li>
            <li>On your device, go to Settings > Developer options > Wireless debugging and toggle the switch to turn it
              on.</li>
            <li>On your computer, open a terminal or command prompt and enter the following command:
              <code>adb tcpip 5555</code></li>
            <li>Disconnect your device from the USB cable.</li>
            <li>Find the IP address of your device by going to Settings > About phone > Status > IP address.</li>
            <li>On your computer, enter the following command in the terminal or command prompt:
              <code>adb connect [device IP address]:5555</code></li>
            <li>If successful, you should see a message saying "connected to [device IP address]:5555".</li>
            <li>You can now use adb commands wirelessly.</li>
          </ul>
        </div>
